...
import logoQD from "../../../assets/image/QĐ_transparent.png";
        ...
        <div className="home-page-mobile_wrapper row">
          ...
          <div className="more-info">
            ...
            <div className="logo" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
              <img width={"100px"} src={logoQD} alt="logo" />
              <div className="copyright" style={{ fontWeight: "600", textTransform: "capitalize" }}>
                &#169; Copyright by QĐ
              </div>
            </div>
          </div>
