...
function SearchMobile() {
  ...
  return (
    <div className="search-mobile-container">
      {/* <SpeechComponent setSearchInput={setSearchInput} isOpenSpeech={isOpenSpeech} setIsOpenSpeech={setIsOpenSpeech} /> */}
      {isOpenSpeech && (
        <SpeechComponent
        ...
        <div className="row">
          <div className="input_wrapper col col-10">
            ...
            <div className="btn-container">
              ...
              <i onClick={() => setIsOpenSpeech(true)} className="fa-solid fa-microphone"></i>
            </div>
